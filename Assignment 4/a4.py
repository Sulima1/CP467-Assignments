...
def faceRecognition(faceInput, faceGrey):
    ...
    cv.imwrite("Assignment 4/outputs/faceOutput.png", faceInput)
...
def imageManipulation(backgroundImage, figureImage):
    ...
    #convert BGR to HSV and reduce saturation
    ...
    #display the result
    cv.imwrite("Assignment 4/outputs/mixedImage.png", result) 
...
def imageStitching(leftImage, leftImageGrey, rightImage, rightImageGrey):
    ...
    cv.imwrite("Assignment 4/outputs/Panorama.png", result)
